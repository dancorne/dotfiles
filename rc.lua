...
terminal = os.getenv("HOME") .. "/code/alacritty/target/release/alacritty"
...
-- Default keys below (with some overridden ones commented out.
...
--    { rule = { class = "Keepassx" },
--      except = { type = "dialog" },
--      properties = { tag = awful.tag.find_by_name("pass") } },
